...
public class FourToneActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.rt_word_no9)
    RelativeLayout rtWordNo9;
    @BindView(R.id.rt_word_no10)
    RelativeLayout rtWordNo10;
    @BindView(R.id.rt_word_no11)
    RelativeLayout rtWordNo11;
    @BindView(R.id.rt_word_no12)
    RelativeLayout rtWordNo12;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tbFind.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(FourToneActivity.this, FourthActivity.class);
                finish();
            }
        });
        SharedPreferences spProgress = getSharedPreferences("sp_progress", Context.MODE_PRIVATE);
        progress = spProgress.getInt("spProgress", 0);
        tbFind.setNavigationIcon(R.mipmap.ic_arrow_left);
        setSupportActionBar(tbFind);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
    ...
    private void initEvent() {
        ...
        rtWordNo9.setOnClickListener(this);
        rtWordNo10.setOnClickListener(this);
        rtWordNo11.setOnClickListener(this);
        rtWordNo12.setOnClickListener(this);
        tbFind.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
        ...
        mCheckMsgHandler = new Handler(mCheckmsgThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                mHandler.post(new Runnable() {
                                  ...
                                  public void run() {
                                      ...
                                      if (surplusMediaSum == arr.length) {
                                          ...
                                          intent.setClass(FourToneActivity.this, FourToneLastActivity.class);
                                          startActivity(intent);
                                          finish();
                                      }
                                  }
                ...
                if (surplusMediaSum != arr.length) {
                    ...
                    rtWordNo9.setFocusable(false);
                    rtWordNo10.setFocusable(false);
                    rtWordNo11.setFocusable(false);
                    rtWordNo12.setFocusable(false);
                }
                if (isUpdateInfo) {
    ...
    private void changeMedia(int data) {
        ...
        releaseMediaPlayer();
        mMediaPlayer = MediaPlayer.create(FourToneActivity.this, data);
        setBalance(100, progress);
        mMediaPlayer.start();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rt_word_no8:
                ...
                break;
            case R.id.rt_word_no9:
                if (clickNum < 1) {
                    rtWordNo9.setBackgroundResource(R.color.drop_down_unselected);
                    recordThePoints((String) rtWordNo9.getTag());
                    clickNum++;
                }
                break;
            case R.id.rt_word_no10:
                if (clickNum < 1) {
                    rtWordNo10.setBackgroundResource(R.color.drop_down_unselected);
                    recordThePoints((String) rtWordNo10.getTag());
                    clickNum++;
                }
                break;
            case R.id.rt_word_no11:
                if (clickNum < 1) {
                    rtWordNo11.setBackgroundResource(R.color.drop_down_unselected);
                    recordThePoints((String) rtWordNo11.getTag());
                    clickNum++;
                }
                break;
            case R.id.rt_word_no12:
                if (clickNum < 1) {
                    rtWordNo12.setBackgroundResource(R.color.drop_down_unselected);
                    recordThePoints((String) rtWordNo12.getTag());
                    clickNum++;
                }
                break;
            default:
    ...
    private void recordThePoints(String selectWord) {
        ...
        String leftWord = twoWord.substring(0, 2);
        String rightWord = twoWord.substring(2);
    ...
    private void resetBackground() {
        ...
        rtWordNo9.setBackgroundResource(R.color.white);
        rtWordNo10.setBackgroundResource(R.color.white);
        rtWordNo11.setBackgroundResource(R.color.white);
        rtWordNo12.setBackgroundResource(R.color.white);

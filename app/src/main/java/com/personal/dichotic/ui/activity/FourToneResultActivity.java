...
public class FourToneLastActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        errorScore = 56-leftScore-rightScore;
        ...
        if (rightScore > leftScore) {
            tvReaScore.setText(mFormat.format(((float) reaScore / 56 * 100)) + "%");
        }else{
            tvReaScore.setText(" -"+mFormat.format(((float) reaScore / 56 * 100)) + "%");
        }
        tvSameScore.setText(mFormat.format(((float) sameScore / 8 * 100))+"%"+"("+sameScore+"/8)");
    }
    ...
    private void setToolbar() {
        ...
        tbFind.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(FourToneLastActivity.this, SelectionPatternActivity.class);
    ...
    private void setPieChart() {
        ...
        strings.add(new PieEntry((float) leftScore / 56 * 100, "左耳分数:" + leftScore + "/56"));
        strings.add(new PieEntry((float) rightScore / 56 * 100, "右耳分数:" + rightScore + "/56"));
        strings.add(new PieEntry((float) errorScore / 56 * 100, "错误分数:" + errorScore + "/56"));
